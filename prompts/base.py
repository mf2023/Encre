...
class YmiPromptTemplate(YmiBasePrompt):
    """General-purpose prompt template using the layered builder."""

    def __init__(self, builder: YmiPromptBuilder | None = None, specialty: str = "general") -> None:
        self._builder = builder or YmiPromptBuilder()
    ...
    @property
    def builder(self) -> YmiPromptBuilder:
