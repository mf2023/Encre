...
class ToolRegistry:
    def __init__(self) -> None:
        self._tools: dict[str, YmiTool] = {}

    def register(self, tool: YmiTool) -> None:
        self._tools[tool.name] = tool

    def register_many(self, tools: list[YmiTool]) -> None:
        for tool in tools:
            self.register(tool)

    def get(self, name: str) -> YmiTool | None:
