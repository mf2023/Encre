...
"""
IRC Platform Adapter for Encre.

A plugin-based gateway adapter that connects to an IRC server and relays
messages to/from the Encre agent.  Zero external dependencies 鈥?uses
...
class IRCAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config, **kwargs):
        ...
        try:
            ...
            self.port = 6697
        self.nickname = os.getenv("IRC_NICKNAME") or extra.get("nickname", "encre-bot")
        ...
        # IRC nicks are case-insensitive 鈥?normalise for lookups
    ...
    # 鈹€鈹€ Connection lifecycle 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            from encre.gateway.status import acquire_scoped_lock, release_scoped_lock
        ...
        try:
            ...
            logger.error("IRC: failed to connect to %s:%s 鈥?%s", self.server, self.port, e)
        ...
        await self._send_raw(f"USER {self.nickname} 0 * :Encre Agent")
    ...
    async def disconnect(self) -> None:
        ...
        if self._writer and not self._writer.is_closing():
            try:
                await self._send_raw("QUIT :Encre Agent shutting down")
    ...
    # 鈹€鈹€ Sending 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    async def send_typing(self, chat_id: str, metadata=None) -> None:
        """IRC has no typing indicator 鈥?no-op."""
        pass
    ...
    # 鈹€鈹€ Message splitting 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    def _strip_markdown(text: str) -> str:
        ...
        # Bold: **text** or __text__ 鈫?text
        text = re.sub(r"\*\*(.+?)\*\*", r"\1", text)
        text = re.sub(r"__(.+?)__", r"\1", text)
        # Italic: *text* or _text_ 鈫?text
        text = re.sub(r"\*(.+?)\*", r"\1", text)
        text = re.sub(r"(?<!\w)_(.+?)_(?!\w)", r"\1", text)
        # Inline code: `text` 鈫?text
        text = re.sub(r"`(.+?)`", r"\1", text)
        # Code blocks: ```...``` 鈫?content
        text = re.sub(r"```\w*\n?", "", text)
        # Images: ![alt](url) 鈫?url  (must come BEFORE links)
        text = re.sub(r"!\[([^\]]*)\]\(([^)]+)\)", r"\2", text)
        # Links: [text](url) 鈫?text (url)
        text = re.sub(r"\[([^\]]+)\]\(([^)]+)\)", r"\1 (\2)", text)
        return text

    # 鈹€鈹€ Raw IRC I/O 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    async def _receive_loop(self) -> None:
        """Main receive loop 鈥?reads lines and dispatches them."""
        buffer = b""
        try:
    ...
    async def _handle_line(self, raw: str) -> None:
        ...
        # RPL_WELCOME (001) 鈥?registration complete
        if command == "001":
        ...
        # ERR_NICKNAMEINUSE (433) 鈥?nick collision during registration
        if command == "433":
            # Retry with incrementing suffix: encre_, encre_1, encre_2...
        ...
        # PRIVMSG 鈥?incoming message (channel or DM)
        if command == "PRIVMSG" and len(params) >= 2:
            ...
            # CTCP ACTION (/me) 鈥?convert to text
        ...
        # NICK 鈥?track our own nick changes
...
def check_requirements() -> bool:
    ...
    Only requires the server and channel 鈥?no external pip packages needed.
    """
    ...
    # encre setup / requirements check path.
...
def interactive_setup() -> None:
    """Interactive `encre gateway setup` flow for the IRC platform.

    Lazy-imports ``encre.setup`` helpers so the plugin stays importable
    in non-CLI contexts (gateway runtime, tests).
    """
    from encre.setup import (
        prompt,
        prompt_yes_no,
        save_env_value,
        get_env_value,
    ...
    print_info("Connect Encre to an IRC network. Uses Python stdlib 鈥?no extra packages needed.")
    ...
    if not server:
        print_warning("Server is required 鈥?skipping IRC setup")
        return
    ...
    if port:
        try:
            ...
            print_warning(f"Invalid port 鈥?using default {default_port}")
    elif get_env_value("IRC_PORT"):
        # User cleared the prompt; drop the override so the default applies.
        save_env_value("IRC_PORT", "")

    nickname = prompt(
        "Bot nickname (e.g. encre-bot)",
        default=get_env_value("IRC_NICKNAME") or "",
    )
    if not nickname:
        print_warning("Nickname is required 鈥?skipping IRC setup")
        return
    save_env_value("IRC_NICKNAME", nickname.strip())

    channel = prompt(
        "Channel to join (e.g. #encre 鈥?comma-separate for multiple)",
        default=get_env_value("IRC_CHANNEL") or "",
    )
    if not channel:
        print_warning("Channel is required 鈥?skipping IRC setup")
        return
    save_env_value("IRC_CHANNEL", channel.strip())

    print()
    print_info("馃攽 Optional authentication")
    ...
    print()
    print_info("馃敀 Access control: restrict who can message the bot")
    print_info("   IRC nicks are not authenticated 鈥?anyone can claim any nick.")
    ...
    if allow_all:
        ...
        print_warning("鈿狅笍  Open access 鈥?any nick in the channel can command the bot.")
    else:
        ...
        if allowed:
            ...
            save_env_value("IRC_ALLOWED_USERS", "")
            print_info("No nicks allowed 鈥?the bot will ignore all messages until you add nicks.")

    print()
    print_success("IRC configuration saved to data dir/.env")
    print_info("Restart the gateway for changes to take effect: encre gateway restart")
...
def _env_enablement() -> dict | None:
    ...
    the core hook 鈥?it becomes a proper ``HomeChannel`` dataclass on the
...
async def _standalone_send(
    ...
    *,
    ...
    nickname = os.getenv("IRC_NICKNAME") or extra.get("nickname", "encre-bot")
    ...
    nick_base = nickname.rstrip("_0123456789-")[:24] or "encre-bot"
    ...
    try:
        ...
        await _raw(f"USER {standalone_nick} 0 * :Encre Agent (cron)")
