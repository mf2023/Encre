...
safely imported by any sub-module 鈥?including ``crypto.py`` which is used at
...
# ---------------------------------------------------------------------------
# QQBot adapter version 鈥?bump on functional changes to the adapter package.
# ---------------------------------------------------------------------------
...
# OAuth2 token endpoint 鈥?POST appId + clientSecret 鈫?access_token.
TOKEN_URL = "https://bots.qq.com/app/getAppAccessToken"

# WebSocket gateway URL path 鈥?GET /gateway with auth header 鈫?gateway URL.
