...
Keyboard structure (QQ Bot v2)::
    ...
    InlineKeyboard
        鈹斺攢鈹€ content: KeyboardContent
            鈹斺攢鈹€ rows: List[KeyboardRow]
                鈹斺攢鈹€ buttons: List[KeyboardButton]
                    鈹溾攢鈹€ id: str              鈥?unique button identifier
                    鈹溾攢鈹€ render_data: KeyboardButtonRenderData
                    鈹?  鈹溾攢鈹€ label: str       鈥?pre-click display text
                    鈹?  鈹溾攢鈹€ visited_label: str 鈥?post-click display text
                    鈹?  鈹斺攢鈹€ style: int       鈥?0=grey, 1=blue
                    鈹斺攢鈹€ action: KeyboardButtonAction
                        鈹溾攢鈹€ type: int          鈥?1=callback, 2=link
                        鈹溾攢鈹€ data: str          鈥?button_data payload
                        鈹溾攢鈹€ permission: KeyboardButtonPermission
                        鈹斺攢鈹€ click_limit: int  鈥?max clicks per user (1=single-use)
"""
...
# 鈹€鈹€ button_data prefixes + patterns 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
# Simple two-option pattern 鈥?only accepts 'y' or 'n'.
_UPDATE_PROMPT_RE = re.compile(r"^update_prompt:(y|n)$")


# 鈹€鈹€ Keyboard dataclasses 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
class KeyboardButtonAction:
    ...
    Two action types supported by QQ Bot v2:
        type=1: Callback 鈥?triggers INTERACTION_CREATE event on click.
            The ``data`` field is delivered as ``button_data`` in the event.
        type=2: Link 鈥?opens a URL in the client.
...
class KeyboardButton:
    ...
    Attributes:
        ...
        group_id: Buttons sharing the same group_id are mutually exclusive 鈥?            clicking one greys out all other buttons in the group.
...
class InlineKeyboard:
    """Top-level keyboard payload 鈥?goes into ``MessageToCreate.keyboard``.
...
# 鈹€鈹€ INTERACTION_CREATE parsing 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
# 鈹€鈹€ Keyboard builders 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def _make_callback_button(
    ...
    Args:
        ...
        group_id: Mutual exclusion group 鈥?buttons in the same group
...
# 鈹€鈹€ ApprovalRequest + text builder 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def _build_plugin_text(req: ApprovalRequest) -> str:
    ...
    Format:
        ...
        鈴憋笍 瓒呮椂: <timeout_sec> 绉?
    Icon mapping:
        severity='critical' 鈫?馃敶 red
        severity='info'     鈫?馃數 blue
        otherwise           鈫?馃煛 yellow
    """
    # Select icon color based on severity level.
    icon = (
        "馃敶" if req.severity == "critical"
        else "馃數" if req.severity == "info"
        else "馃煛"
    )
    lines: List[str] = [f"{icon} **瀹℃壒璇锋眰**", ""]
    lines.append(f"馃搵 {req.title}")
    if req.description:
        lines.append(f"馃摑 {req.description}")
    if req.tool_name:
...
# 鈹€鈹€ ApprovalSender 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
class ApprovalSender:
    ...
    async def send(
        ...
        logger.info(
            "[%s] Sending approval request to %s:%s (session=%.20s鈥?",
...
# 鈹€鈹€ INTERACTION_CREATE event shape 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
class InteractionEvent:
    ...
    Attributes:
        id: Interaction event id 鈥?required for the ``PUT /interactions/{id}`` ACK.
    ...
    """
    id: str = ""
    """Interaction event id 鈥?required for the ``PUT /interactions/{id}`` ACK."""
    ...
    scene: str = ""
    """``'guild'`` | ``'group'`` | ``'c2c'`` 鈥?human-readable scene."""
    ...
    def operator_openid(self) -> str:
        """Best available operator openid (group 鈫?member; c2c 鈫?user).
