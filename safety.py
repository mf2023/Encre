...
class YmiSafetyEngine:
    def __init__(
        ...
        workspace: str = "",
        auto_classifier: "YmiAutoSafetyClassifier | None" = None,
    ) -> None:
        self.config = config
        ...
        if sandbox_enabled and workspace:
            self.sandbox = YmiContainerSandbox(workspace, sandbox_config or SandboxConfig())
        else:
            self.sandbox = None
        self._ssrf_guard = YmiSSRFGuard()
