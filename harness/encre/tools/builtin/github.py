...
async def _github_execute(**kwargs: Any) -> str:
    ...
    async with httpx.AsyncClient(base_url=api_base, headers=headers, timeout=httpx.Timeout(60.0)) as client:
        ...
        # 鈹€鈹€ Repositories 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
            ...
            out = [f"{r['full_name']} ({r['description'] or 'no description'}) 鈽厈r['stargazers_count']}" for r in items]
            ...
            if resp.is_error:
                return _error(resp)
            repos = resp.json()
            out = [f"{r['full_name']} ({r.get('language','') or 'N/A'}) 鈽厈r['stargazers_count']}" for r in repos]
