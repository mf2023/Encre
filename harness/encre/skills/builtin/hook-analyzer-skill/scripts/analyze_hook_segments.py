...
"""
浠庡垎闀滄媶瑙ｇ粨鏋滀腑鎻愬彇鍓嶄笁绉掑垎闀滄暟鎹紝鏋勯€犻挬瀛愬垎鏋愪笂涓嬫枃銆?
...
def analyze_hook_segments(breakdown_data: dict) -> dict:
    """
    鎻愬彇骞跺垎鏋愯棰戝墠涓夌鐨勫垎闀滄暟鎹紝涓洪挬瀛愬垎鏋愭彁渚涚粨鏋勫寲涓婁笅鏂囥€?

    Args:
        breakdown_data: 瀹屾暣鐨勫垎闀滄媶瑙ｇ粨鏋滐紙鍖呭惈 segments 瀛楁锛?
    ...
    print(
        f"鍓嶄笁绉掓彁鍙栧畬鎴? {len(first_segments)}涓垎闀? "
        f"鎬绘椂闀縶cumulative_time:.1f}s, 鍏抽敭甯total_frames}寮?,
        file=sys.stderr,
    )
