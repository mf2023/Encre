...
description: Use this skill whenever a user wants to dispute a charge, file a chargeback, contest a transaction, or fight an unauthorized payment.
metadata:
  source: encre
...
- **external documentation** — Visa dispute reason codes and evidence rules
- **external documentation** — Mastercard dispute reason codes and evidence rules
- **external documentation** — Amex dispute process (simpler, more consumer-friendly)
- **external documentation** — PayPal and Stripe dispute flows (different from card networks)
...
- **external documentation** — Visa reason codes, evidence requirements, timelines
- **external documentation** — Mastercard reason codes, evidence requirements, timelines
- **external documentation** — Amex dispute codes, process, timelines
- **external documentation** — PayPal and Stripe dispute flows, timelines, escalation