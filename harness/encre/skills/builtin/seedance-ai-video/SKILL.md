...
description: Generate AI videos using ByteDance's Seedance 1.5 Pro — a native audio-visual joint generation model with cinematic camera control, multi-language lip
metadata:
  source: clawhub
  tags: seedance-ai-video
user_invocable: true
hidden: true
context: inline
---
