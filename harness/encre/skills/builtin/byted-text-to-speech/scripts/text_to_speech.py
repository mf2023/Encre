...
Ref: https://www.volcengine.com/docs/6561/1598757 (HTTP Chunked/SSE 鍗曞悜娴佸紡-V3)
閴存潈: 鏂扮増鎺у埗鍙?API Key 鏂规 https://console.volcengine.com/speech/new/setting/apikeys
"""
...
def _build_headers() -> dict:
    """鏋勫缓璇锋眰澶淬€備娇鐢ㄦ柊鐗堟帶鍒跺彴 X-Api-Key 閴存潈銆?""
    headers = {
    ...
    if not api_key:
        raise PermissionError(
            ...
            "瑙?https://console.volcengine.com/speech/new/setting/apikeys"
        )
...
def text_to_speech(
    ...
    """
    璋冪敤鐏北寮曟搸璞嗗寘璇煶鍚堟垚 API锛屽皢鏂囨湰杞负璇煶骞朵繚瀛樹负鏂囦欢銆?
    Returns:
        鍖呭惈 status, local_path, format, error 鐨勫瓧鍏?    """
