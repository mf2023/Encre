...
"""
ensure_ffmpeg.py 鈥?鑷姩妫€娴嬪苟瀹夎 ffmpeg / ffprobe銆?
...
杩斿洖 JSON:
  ...
  ffmpeg_path / ffprobe_path: 鍙墽琛屾枃浠惰矾寰?(鎴愬姛鏃?
  commands: 灏嗚/宸茬粡鎵ц鐨勫畨瑁呭懡浠?
  source_policy: 濮嬬粓涓?"package_manager_only"锛堜笉浠?GitHub/npm 涓嬭浇锛?
