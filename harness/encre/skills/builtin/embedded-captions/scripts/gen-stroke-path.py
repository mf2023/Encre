...
"""gen-stroke-path.py 鈥?generalized draw-on path generator.

Lays out ANY word in a single-line (pen-path) SVG font 鈥?Hershey/EMS 鈥?and emits
...
s = target_w / total                       # scale font-units 鈫?px
