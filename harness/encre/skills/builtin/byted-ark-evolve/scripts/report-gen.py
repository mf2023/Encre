...
LAYER_BADGE = {
    "identity": ("badge-identity", "\u8eab\u4efd"),  # 韬唤
    "context": ("badge-context", "\u4e0a\u4e0b\u6587"),  # 涓婁笅鏂?    "protocol": ("badge-protocol", "\u534f\u8bae"),  # 鍗忚
    "capability": ("badge-capability", "\u80fd\u529b"),  # 鑳藉姏
    "runtime": ("badge-runtime", "\u8fd0\u884c\u65f6"),  # 杩愯鏃?}
...
""")
    ...
    # 鈹€鈹€ Pending proposals 鈹€鈹€
    if pending_proposals:
        h.append("<hr>\n<h2>寰呭鐞嗘彁妗堥槦鍒?/h2>\n")
        h.append(
            '<p style="font-size:15px;color:var(--muted);margin-bottom:16px">杩欎簺 proposal 灏氭湭琚敤鎴锋渶缁堢‘璁わ紝鍥犳浼氬湪鍚庣画 session_start 涓户缁彲瑙侊紝鐩村埌 accepted / rejected / stale / superseded銆?/p>\n'
        )
        h.append("<table>\n")
        h.append(
            "  <thead><tr><th>Proposal</th><th>鐘舵€?/th><th>鍙樻洿鏁?/th><th>鎽樿</th><th>鐢熸垚鏃堕棿</th></tr></thead>\n  <tbody>\n"
        )
        ...
        h.append("  </tbody>\n</table>\n")
    # 鈹€鈹€ Signal distribution by layer 鈹€鈹€
    if signal_layers:
        h.append("<hr>\n<h2>\u4fe1\u53f7\u5206\u5e03\uff08\u6309\u5c42\uff09</h2>\n")
        h.append(
    ...
    # 鈹€鈹€ High severity signals detail 鈹€鈹€
