...
def _minimax_prompt(raw: str) -> str:
    ...
    provider adapts the input itself 鈥?the caller never needs to know MiniMax is
...
def _generate_image_minimax(
    ...
    if reference_images:
        ...
        # path we do not pre-validate them 鈥?invalid files surface as a MiniMax API error.
