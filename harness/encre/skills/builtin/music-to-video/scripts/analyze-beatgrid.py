...
Turns a BGM track directly into a deterministic `audiomap.json` 鈥?the music skeleton
that the Director and Builder hang visuals on. It merges:
  ...
  - an energy narrative (audio-driven energy phases + builds + key moments; the Music
    Reader names the sections 鈥?no fixed Intro/Build/Drop/Outro template),
...
# 鈹€鈹€ decode 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
# 鈹€鈹€ tempo + beat grid + downbeat phase 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
# 鈹€鈹€ metrical position: strong / weak / syncopated / off-grid 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def classify_metric(t: float, beats: np.ndarray, phase: int, bpb: int = 4) -> tuple:
    ...
    # distance to the nearest 16th line (in seconds) 鈫?off-grid test
...
# 鈹€鈹€ drum classification (band-split heuristic) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def classify_drum(t: float, bc: dict, sr: int) -> tuple:
    ...
    if lead_val < 0.06:                      # no real transient 鈫?texture/perc
        drum = "glitch" if flat > 0.30 else "perc"
    elif lead == "snare" and flat > 0.30 and mr < 0.30:
        drum = "glitch"                      # mid-band but noisy & thin 鈫?scratch/glitch
    else:
        drum = lead
...
# 鈹€鈹€ energy structure (RMS @1s) + sections + key moments + builds 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
def energy_structure(y: np.ndarray, sr: int, dur: float, first_onset: float = 0.0) -> dict:
    ...
    # hard stop: a HIGH鈫抣ow cliff (a sudden stop) in the back third
    ...
    # (LLM) decides the actual sections 鈥?count, boundaries, and free-form names 鈥?from
...
# 鈹€鈹€ rolls / fills (localized rapid-onset runs) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
# stream 鈥?runs never overlap, so no dedup is needed (unlike a band-energy detector).
ROLL_MIN_HITS = 4
ROLL_CONT = 0.55      # 脳 beat_dur: gap up to ~half a beat still keeps a run alive
ROLL_ACCEPT = 0.42    # 脳 beat_dur: mean spacing denser than an 8th note counts
...
def detect_rolls(events: list, beat_dur: float) -> list:
    ...
    while a sparse groove stays out 鈥?validated against the golden 7.5-9.5s roll.
...
# 鈹€鈹€ per-section spectral character (sustained "feel") 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
# 鈹€鈹€ audiomap enrichment: phrase layer + section density budgets 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def analyze(path: str, phrase_bars: int = 4) -> dict:
    ...
    # near-silent windows (= VOID energy phases) 鈥?convenience for "hold / breathe"
    ...
    summary = (f"{bg['bpm']:.0f} BPM 路 {len(beats)} beats / {len(downbeats)} bars 路 "
               f"{len(events)} events ({n_drum}) 路 {len(rolls)} rolls 路 "
               f"{len(es['phases'])} energy phases 路 {dur:.1f}s")
...
def print_brief(d: dict) -> None:
    ...
    for m in d["key_moments"]:
        print(f"  {m['t']:3d}s  {m['kind']:5s}  螖{m['delta']:+.2f}")
    print(f"HARD STOPS: {[h['t'] for h in d['hard_stops']]}")
    print("ROLLS / FILLS")
    for r in d.get("rolls", []):
        lead = f"  鈫?{r['leads_to']}" if r.get("leads_to") else ""
    ...
    print(f"\nEVENTS ({len(d['events'])})  [t 路 bar:beat 路 grid 路 drum 路 energy 路 special]")
    for e in d["events"]:
...
def main() -> None:
    ...
    if a.out:
        ...
        print(
            f"[analyze-beatgrid] wrote audiomap {a.out} 路 {len(d.get('energy_phases', []))} phases 路 density [{dens}]",
            file=sys.stderr,
        )
