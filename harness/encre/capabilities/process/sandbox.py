...
def remap_tool_path(file_path: str) -> str:
    ...
    if result:
        return result
    # Path was rejected 鈥?force-remap into the session files dir as filename only
...
def remap_path(
    ...
    1. **Empty / whitespace path** 鈫?reject (empty string).
    ...
    # 鈹€鈹€ Workspace mode 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    if workspace_root and os.path.isdir(workspace_root):
        return _resolve_workspace_path(file_path, workspace_root)

    # 鈹€鈹€ General mode: session files directory 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def _resolve_workspace_path(file_path: str, workspace: str) -> str:
    ...
    # 鈹€鈹€ Relative paths (including stripped /workspace/) 鈹€鈹€
...
def _resolve_session_files_path(
    ...
    - **Relative paths** (``output.txt``, ``./foo``) are resolved **relative
      to the session files directory** 鈥?this is the default when no path
    ...
    # 鈹€鈹€ Absolute path: user/context specified a location 鈥?pass through 鈹€鈹€
    if p.is_absolute():
    ...
    # 鈹€鈹€ Relative paths: resolve against the session files directory 鈹€鈹€
    try:
...
# 鈹€鈹€ Command-level path safety 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
