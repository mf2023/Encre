"""EA chargeback-assistant skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-chargeback-assistant",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: chargeback-assistant.",
        ...
        provides_skills=["chargeback-assistant"],
        activation_events=[],
        permissions=[],
    )
