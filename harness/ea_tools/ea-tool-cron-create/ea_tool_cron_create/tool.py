...
cron_create_tool = build_tool(
    ...
    description=(
        ...
        "Pitfalls: the agent has no prior context at fire time 鈥?include all "
...
cron_create_tool.set_scheduler = set_scheduler
