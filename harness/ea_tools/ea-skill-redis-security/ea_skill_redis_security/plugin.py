"""EA redis-security skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-redis-security",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: redis-security.",
        ...
        provides_skills=["redis-security"],
        activation_events=[],
        permissions=[],
    )
