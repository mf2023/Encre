"""EA iris-development skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-iris-development",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: iris-development.",
        ...
        provides_skills=["iris-development"],
        activation_events=[],
        permissions=[],
    )
