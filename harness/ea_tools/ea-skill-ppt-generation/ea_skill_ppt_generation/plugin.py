"""EA ppt-generation skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-ppt-generation",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: ppt-generation.",
        ...
        provides_skills=["ppt-generation"],
        activation_events=[],
        permissions=[],
    )
