"""EA weixin-webhook skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-weixin-webhook",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: weixin-webhook.",
        ...
        provides_skills=["weixin-webhook"],
        activation_events=[],
        permissions=[],
    )
