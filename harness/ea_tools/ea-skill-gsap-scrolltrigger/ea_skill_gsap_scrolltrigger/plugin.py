"""EA gsap-scrolltrigger skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-gsap-scrolltrigger",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: gsap-scrolltrigger.",
        ...
        provides_skills=["gsap-scrolltrigger"],
        activation_events=[],
        permissions=[],
    )
