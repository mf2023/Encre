"""EA frontend-design skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-frontend-design",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: frontend-design.",
        ...
        provides_skills=["frontend-design"],
        activation_events=[],
        permissions=[],
    )
