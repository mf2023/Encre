"""EA byted-las-video-edit skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-byted-las-video-edit",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: byted-las-video-edit.",
        ...
        provides_skills=["byted-las-video-edit"],
        activation_events=[],
        permissions=[],
    )
