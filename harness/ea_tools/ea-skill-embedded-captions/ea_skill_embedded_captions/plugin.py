"""EA embedded-captions skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-embedded-captions",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: embedded-captions.",
        ...
        provides_skills=["embedded-captions"],
        activation_events=[],
        permissions=[],
    )
