"""EA captions-overlay skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-captions-overlay",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: captions-overlay.",
        ...
        provides_skills=["captions-overlay"],
        activation_events=[],
        permissions=[],
    )
