"""EA byted-mediakit-audio skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-byted-mediakit-audio",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: byted-mediakit-audio.",
        ...
        provides_skills=["byted-mediakit-audio"],
        activation_events=[],
        permissions=[],
    )
