"""EA music-generation skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-music-generation",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: music-generation.",
        ...
        provides_skills=["music-generation"],
        activation_events=[],
        permissions=[],
    )
