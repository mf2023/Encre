"""EA remotion-to-hyperframes skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-remotion-to-hyperframes",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: remotion-to-hyperframes.",
        ...
        provides_skills=["remotion-to-hyperframes"],
        activation_events=[],
        permissions=[],
    )
