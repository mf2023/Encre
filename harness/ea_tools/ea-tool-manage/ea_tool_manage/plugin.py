...
from ea_tool_manage.tool import manage_tool


def create_plugin() -> EncrePlugin:
    return _ManagePlugin()


class _ManagePlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-tool-manage",
        version="0.4.3",
        description="EA (Encre Agent) system-default tools: manage.",
