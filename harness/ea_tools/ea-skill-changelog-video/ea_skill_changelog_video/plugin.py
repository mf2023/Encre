"""EA changelog-video skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-changelog-video",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: changelog-video.",
        ...
        provides_skills=["changelog-video"],
        activation_events=[],
        permissions=[],
    )
