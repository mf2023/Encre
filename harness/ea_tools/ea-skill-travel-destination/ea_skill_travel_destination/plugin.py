"""EA travel-destination skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-travel-destination",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: travel-destination.",
        ...
        provides_skills=["travel-destination"],
        activation_events=[],
        permissions=[],
    )
