"""EA hyperframes-cli skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-hyperframes-cli",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: hyperframes-cli.",
        ...
        provides_skills=["hyperframes-cli"],
        activation_events=[],
        permissions=[],
    )
