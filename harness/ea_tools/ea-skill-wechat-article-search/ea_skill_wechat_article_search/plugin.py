"""EA wechat-article-search skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-wechat-article-search",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: wechat-article-search.",
        ...
        provides_skills=["wechat-article-search"],
        activation_events=[],
        permissions=[],
    )
