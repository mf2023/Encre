...
description: Read, search, and manage Outlook emails and calendar via Microsoft Graph API with delegate support.
metadata:
  source: encre
  tags: 
user_invocable: true
...
- Based on outlook v1.3.0 by jotamed (https://encre.ai/jotamed/outlook)