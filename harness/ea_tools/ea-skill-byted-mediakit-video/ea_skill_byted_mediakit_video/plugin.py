"""EA byted-mediakit-video skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-byted-mediakit-video",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: byted-mediakit-video.",
        ...
        provides_skills=["byted-mediakit-video"],
        activation_events=[],
        permissions=[],
    )
