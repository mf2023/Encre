"""EA market-research skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-market-research",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: market-research.",
        ...
        provides_skills=["market-research"],
        activation_events=[],
        permissions=[],
    )
