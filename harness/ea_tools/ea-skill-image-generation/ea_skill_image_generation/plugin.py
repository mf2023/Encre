"""EA image-generation skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-image-generation",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: image-generation.",
        ...
        provides_skills=["image-generation"],
        activation_events=[],
        permissions=[],
    )
