"""EA product-launch-video skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-product-launch-video",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: product-launch-video.",
        ...
        provides_skills=["product-launch-video"],
        activation_events=[],
        permissions=[],
    )
