"""EA byted-mediakit-editing skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-byted-mediakit-editing",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: byted-mediakit-editing.",
        ...
        provides_skills=["byted-mediakit-editing"],
        activation_events=[],
        permissions=[],
    )
