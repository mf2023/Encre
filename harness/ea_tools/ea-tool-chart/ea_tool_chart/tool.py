...
chart_tool = build_tool(
    name="chart",
    description=(
        "Generate data visualizations with matplotlib 鈥?line, bar, scatter, pie, "
        "histogram, area, or heatmap 鈥?and return a PNG (base64) or save to disk. "
        ...
        "datasets inflate the base64 payload 鈥?prefer `output_path` then."
    ),
    input_schema={
        "type": "object",
        "properties": {
