"""EA deep-code-reviewer skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-deep-code-reviewer",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: deep-code-reviewer.",
        ...
        provides_skills=["deep-code-reviewer"],
        activation_events=[],
        permissions=[],
    )
