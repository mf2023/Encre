"""EA faceless-explainer skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-faceless-explainer",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: faceless-explainer.",
        ...
        provides_skills=["faceless-explainer"],
        activation_events=[],
        permissions=[],
    )
