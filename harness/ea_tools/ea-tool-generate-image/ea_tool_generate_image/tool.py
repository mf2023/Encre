...
generate_image_tool = build_tool(
    name="generate_image",
    description=(
...
image_variation_tool = build_tool(
    ...
    description=(
        ...
        "Pitfalls: the active backend must implement create_image_variation 鈥?not "
...
__all__ = ["generate_image_tool", "edit_image_tool", "image_variation_tool"]
