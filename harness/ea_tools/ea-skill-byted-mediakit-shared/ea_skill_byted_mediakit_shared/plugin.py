"""EA byted-mediakit-shared skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-byted-mediakit-shared",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: byted-mediakit-shared.",
        ...
        provides_skills=["byted-mediakit-shared"],
        activation_events=[],
        permissions=[],
    )
