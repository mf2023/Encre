"""EA email-daily-summary skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-email-daily-summary",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: email-daily-summary.",
        ...
        provides_skills=["email-daily-summary"],
        activation_events=[],
        permissions=[],
    )
