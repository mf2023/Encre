"""EA byted-web-search skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-byted-web-search",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: byted-web-search.",
        ...
        provides_skills=["byted-web-search"],
        activation_events=[],
        permissions=[],
    )
