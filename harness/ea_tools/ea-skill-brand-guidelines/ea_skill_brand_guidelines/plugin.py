"""EA brand-guidelines skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-brand-guidelines",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: brand-guidelines.",
        ...
        provides_skills=["brand-guidelines"],
        activation_events=[],
        permissions=[],
    )
