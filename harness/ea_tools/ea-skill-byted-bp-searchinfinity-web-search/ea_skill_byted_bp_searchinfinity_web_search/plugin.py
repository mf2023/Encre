"""EA byted-bp-searchinfinity-web-search skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-byted-bp-searchinfinity-web-search",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: byted-bp-searchinfinity-web-search.",
        ...
        provides_skills=["byted-bp-searchinfinity-web-search"],
        activation_events=[],
        permissions=[],
    )
