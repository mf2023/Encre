"""EA hyperframes-core skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-hyperframes-core",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: hyperframes-core.",
        ...
        provides_skills=["hyperframes-core"],
        activation_events=[],
        permissions=[],
    )
