"""EA react-view-transitions skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-react-view-transitions",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: react-view-transitions.",
        ...
        provides_skills=["react-view-transitions"],
        activation_events=[],
        permissions=[],
    )
