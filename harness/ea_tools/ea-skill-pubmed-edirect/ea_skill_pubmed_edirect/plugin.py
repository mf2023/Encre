"""EA pubmed-edirect skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-pubmed-edirect",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: pubmed-edirect.",
        ...
        provides_skills=["pubmed-edirect"],
        activation_events=[],
        permissions=[],
    )
