"""EA tavily-web-search skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-tavily-web-search",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: tavily-web-search.",
        ...
        provides_skills=["tavily-web-search"],
        activation_events=[],
        permissions=[],
    )
