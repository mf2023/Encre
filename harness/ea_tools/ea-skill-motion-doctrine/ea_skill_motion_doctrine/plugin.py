"""EA motion-doctrine skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-motion-doctrine",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: motion-doctrine.",
        ...
        provides_skills=["motion-doctrine"],
        activation_events=[],
        permissions=[],
    )
