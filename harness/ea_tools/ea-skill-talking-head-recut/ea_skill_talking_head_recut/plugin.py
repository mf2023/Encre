"""EA talking-head-recut skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-talking-head-recut",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: talking-head-recut.",
        ...
        provides_skills=["talking-head-recut"],
        activation_events=[],
        permissions=[],
    )
