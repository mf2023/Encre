...
LAYER_BADGE = {
    "identity": ("badge-identity", "identity"),
    "context": ("badge-context", "context"),
    "protocol": ("badge-protocol", "protocol"),
    "capability": ("badge-capability", "capability"),
    "runtime": ("badge-runtime", "runtime"),
}
...
""")
    ...
    # 鈹鈹 Pending proposals 鈹鈹
    if pending_proposals:
        h.append("<hr>\n<h2>寰呭鐞嗘彁妗堥槦鍒?/h2>\n")
        h.append(
            '<p style="font-size:15px;color:var(--muted);margin-bottom:16px">杩欎簺 proposal 灏氭湭琚敤鎴锋渶缁堢‘璁わ紝鍥犳浼氬湪鍚庣画 session_start 涓户缁彲瑙侊紝鐩村埌 accepted / rejected / stale / superseded銆?/p>\n'
        )
        h.append("<table>\n")
        h.append(
        ...
        h.append("  </tbody>\n</table>\n")
    # 鈹鈹 Signal distribution by layer 鈹鈹
    if signal_layers:
        h.append("<hr>\n<h2>\u4fe1\u53f7\u5206\u5e03\uff08\u6309\u5c42\uff09</h2>\n")
        h.append(
    ...
    # 鈹鈹 High severity signals detail 鈹鈹
