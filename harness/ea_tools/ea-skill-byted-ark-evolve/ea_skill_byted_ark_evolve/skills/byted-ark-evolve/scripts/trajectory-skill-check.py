...
"""
Trajectory 鈫?Skill candidate detection.
...
GOLDEN_THRESHOLD = 3  # 鈮? golden trajectories of same task_type 鈫?skill candidate
CORRECTION_THRESHOLD = 2  # 鈮? corrections with same root_cause 鈫?guardrail candidate
