"""EA douyin-interactive-content-publish skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-douyin-interactive-content-publish",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: douyin-interactive-content-publish.",
        ...
        provides_skills=["douyin-interactive-content-publish"],
        activation_events=[],
        permissions=[],
    )
