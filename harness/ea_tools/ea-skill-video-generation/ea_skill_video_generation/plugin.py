"""EA video-generation skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-video-generation",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: video-generation.",
        ...
        provides_skills=["video-generation"],
        activation_events=[],
        permissions=[],
    )
