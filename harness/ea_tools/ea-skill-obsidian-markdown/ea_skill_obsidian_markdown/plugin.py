"""EA obsidian-markdown skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-obsidian-markdown",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: obsidian-markdown.",
        ...
        provides_skills=["obsidian-markdown"],
        activation_events=[],
        permissions=[],
    )
