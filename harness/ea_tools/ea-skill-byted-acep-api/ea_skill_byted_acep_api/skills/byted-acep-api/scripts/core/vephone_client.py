...
class VePhoneClient:
    ...
    def __init__(
        ...
        Args:
            ...
            version: API 鐗堟湰瑕嗙洊鍊硷紙鍙夛紝榛樿鎸?Action 閫夋嫨锛?
            product_id: 浜у搧 ID锛堝彲閫夛紝鍙湪璋冪敤鏃舵寚瀹氾級
            dc_id: 鏈烘埧 ID锛堝彲閫夛紝鍙湪璋冪敤鏃舵寚瀹氾級
    ...
    def _request(
        ...
        Args:
            action: API 鍔ㄤ綔鍚嶇О
            version: API 鐗堟湰锛堝彲閫夛紝榛樿浣跨敤鍒濆鍖栨椂鐨勭増鏈級
            body: 璇锋眰浣?
            method: HTTP 鏂规硶
    ...
    def create_pod(
        ...
        **kwargs,
        ...
        Args:
            name: 瀹炰緥鍚嶇О
            template_id: 鏈哄瀷妯澘 ID
            configuration_code: 濂楅浠ｇ爜
            count: 鍒涘缓鏁伴噺锛岄粯璁?1
            product_id: 浜у搧 ID锛堝彲閫夛紝榛樿浣跨敤鍒濆鍖栨椂鐨勫硷級
            dc_id: 鏈烘埧 ID锛堝彲閫夛紝璋冪敤鏃舵寜闇瑕佹垨璧勬簮浣欓噺鎸囧畾锛?
            **kwargs: 鍏朵粬鍙傛暟
    ...
    def start_screenshot(self, pod_id: str, **kwargs) -> Dict[str, Any]:
        """鍏煎鏃ц皟鐢紝鍐呴儴澶嶇敤 BatchScreenShot銆"""
