"""EA exa-web-search-free skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-exa-web-search-free",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: exa-web-search-free.",
        ...
        provides_skills=["exa-web-search-free"],
        activation_events=[],
        permissions=[],
    )
