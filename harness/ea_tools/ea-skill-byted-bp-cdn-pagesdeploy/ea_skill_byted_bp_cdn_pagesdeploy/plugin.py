"""EA byted-bp-cdn-pagesdeploy skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-byted-bp-cdn-pagesdeploy",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: byted-bp-cdn-pagesdeploy.",
        ...
        provides_skills=["byted-bp-cdn-pagesdeploy"],
        activation_events=[],
        permissions=[],
    )
