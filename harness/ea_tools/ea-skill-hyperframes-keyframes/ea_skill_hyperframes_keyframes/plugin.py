"""EA hyperframes-keyframes skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-hyperframes-keyframes",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: hyperframes-keyframes.",
        ...
        provides_skills=["hyperframes-keyframes"],
        activation_events=[],
        permissions=[],
    )
