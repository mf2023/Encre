...
"""
inspect_audio.py 鈥?鎺祴闊抽鏂囦欢鐨勬椂闀裤侀噰鏍风巼銆佸０閬撴暟绛夊厓淇伅銆?
...
鎺祴浼樺厛绾?
  ...
  2. macOS afinfo锛堜粎鏈湴鏂囦欢锛屼粎 macOS锛?
  3. Python wave 妯潡锛堜粎 .wav 鏂囦欢锛?
...
def inspect_wav_with_wave(input_value):
    """閫氳繃 Python 鏍囧噯搴?wave 妯潡鎺祴 .wav 鏂囦欢銆"""
