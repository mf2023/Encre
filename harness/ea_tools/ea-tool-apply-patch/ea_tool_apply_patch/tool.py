...
# Atomic write helper 鈥?temp 鈫?fsync 鈫?rename
# 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def _locate(
    ...
    Strategy: prefer the exact target. If that doesn't match, search 卤N lines.
    """
    if not pre:
    ...
    for fd in files:
        ...
        try:
            if fd.is_deleted or fd.new_path == "/dev/null":
                ...
                if not dry_run and os.path.exists(abs_path):
                    os.remove(abs_path)
                entry["action"] = "delete"
                entry["status"] = "ok"
