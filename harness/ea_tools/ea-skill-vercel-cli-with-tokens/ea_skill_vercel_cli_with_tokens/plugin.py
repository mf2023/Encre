"""EA vercel-cli-with-tokens skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-vercel-cli-with-tokens",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: vercel-cli-with-tokens.",
        ...
        provides_skills=["vercel-cli-with-tokens"],
        activation_events=[],
        permissions=[],
    )
