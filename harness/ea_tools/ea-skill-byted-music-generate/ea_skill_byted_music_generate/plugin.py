"""EA byted-music-generate skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-byted-music-generate",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: byted-music-generate.",
        ...
        provides_skills=["byted-music-generate"],
        activation_events=[],
        permissions=[],
    )
