"""EA lovtrip-travel-planner skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-lovtrip-travel-planner",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: lovtrip-travel-planner.",
        ...
        provides_skills=["lovtrip-travel-planner"],
        activation_events=[],
        permissions=[],
    )
