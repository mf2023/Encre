"""EA notion-integration skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-notion-integration",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: notion-integration.",
        ...
        provides_skills=["notion-integration"],
        activation_events=[],
        permissions=[],
    )
