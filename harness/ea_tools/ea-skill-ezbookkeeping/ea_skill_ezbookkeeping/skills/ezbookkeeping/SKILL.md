---
name: ezbookkeeping
description: Use ezBookkeeping API Tools script to record new transactions, query transactions, retrieve account information, retrieve categories, retrieve tags...
metadata:
  source: encre
  tags: 
user_invocable: true
