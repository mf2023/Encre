"""EA seedance-ai-video skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-seedance-ai-video",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: seedance-ai-video.",
        ...
        provides_skills=["seedance-ai-video"],
        activation_events=[],
        permissions=[],
    )
