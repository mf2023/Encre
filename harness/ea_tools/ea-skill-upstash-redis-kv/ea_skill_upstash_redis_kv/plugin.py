"""EA upstash-redis-kv skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-upstash-redis-kv",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: upstash-redis-kv.",
        ...
        provides_skills=["upstash-redis-kv"],
        activation_events=[],
        permissions=[],
    )
