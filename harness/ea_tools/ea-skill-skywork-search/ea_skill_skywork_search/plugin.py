"""EA skywork-search skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-skywork-search",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: skywork-search.",
        ...
        provides_skills=["skywork-search"],
        activation_events=[],
        permissions=[],
    )
