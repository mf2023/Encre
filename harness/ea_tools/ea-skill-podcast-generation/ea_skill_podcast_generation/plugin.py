"""EA podcast-generation skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-podcast-generation",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: podcast-generation.",
        ...
        provides_skills=["podcast-generation"],
        activation_events=[],
        permissions=[],
    )
