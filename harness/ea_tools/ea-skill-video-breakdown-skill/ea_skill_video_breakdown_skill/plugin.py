"""EA video-breakdown-skill skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-video-breakdown-skill",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: video-breakdown-skill.",
        ...
        provides_skills=["video-breakdown-skill"],
        activation_events=[],
        permissions=[],
    )
