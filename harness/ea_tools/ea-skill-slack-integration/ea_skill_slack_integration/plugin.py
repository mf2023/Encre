"""EA slack-integration skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-slack-integration",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: slack-integration.",
        ...
        provides_skills=["slack-integration"],
        activation_events=[],
        permissions=[],
    )
