"""EA x-followings-digest skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-x-followings-digest",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: x-followings-digest.",
        ...
        provides_skills=["x-followings-digest"],
        activation_events=[],
        permissions=[],
    )
