"""EA gsap-performance skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-gsap-performance",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: gsap-performance.",
        ...
        provides_skills=["gsap-performance"],
        activation_events=[],
        permissions=[],
    )
