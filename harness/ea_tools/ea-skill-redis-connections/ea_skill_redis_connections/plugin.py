"""EA redis-connections skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-redis-connections",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: redis-connections.",
        ...
        provides_skills=["redis-connections"],
        activation_events=[],
        permissions=[],
    )
