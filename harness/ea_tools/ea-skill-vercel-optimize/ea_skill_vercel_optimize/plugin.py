"""EA vercel-optimize skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-vercel-optimize",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: vercel-optimize.",
        ...
        provides_skills=["vercel-optimize"],
        activation_events=[],
        permissions=[],
    )
