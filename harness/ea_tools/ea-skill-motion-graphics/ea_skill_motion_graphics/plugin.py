"""EA motion-graphics skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-motion-graphics",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: motion-graphics.",
        ...
        provides_skills=["motion-graphics"],
        activation_events=[],
        permissions=[],
    )
