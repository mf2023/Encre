"""EA redis-observability skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-redis-observability",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: redis-observability.",
        ...
        provides_skills=["redis-observability"],
        activation_events=[],
        permissions=[],
    )
