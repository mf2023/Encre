...
from ea_tool_task_list.tool import task_list_tool


def create_plugin() -> EncrePlugin:
    return _TaskListPlugin()


class _TaskListPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-tool-task-list",
        version="0.4.3",
        description="EA (Encre Agent) system-default tools: task_list.",
