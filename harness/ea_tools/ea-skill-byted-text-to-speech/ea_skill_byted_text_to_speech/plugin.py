"""EA byted-text-to-speech skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-byted-text-to-speech",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: byted-text-to-speech.",
        ...
        provides_skills=["byted-text-to-speech"],
        activation_events=[],
        permissions=[],
    )
