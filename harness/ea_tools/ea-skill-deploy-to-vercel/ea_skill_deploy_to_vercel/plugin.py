"""EA deploy-to-vercel skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-deploy-to-vercel",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: deploy-to-vercel.",
        ...
        provides_skills=["deploy-to-vercel"],
        activation_events=[],
        permissions=[],
    )
