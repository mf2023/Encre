...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-alipay-payment-integration",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: alipay-payment-integration.",
        ...
        provides_skills=["alipay-payment-integration"],
        activation_events=[],
        permissions=[],
    )
