"""EA travel-itinerary skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-travel-itinerary",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: travel-itinerary.",
        ...
        provides_skills=["travel-itinerary"],
        activation_events=[],
        permissions=[],
    )
