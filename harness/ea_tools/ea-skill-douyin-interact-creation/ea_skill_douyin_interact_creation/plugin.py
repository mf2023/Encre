"""EA douyin-interact-creation skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-douyin-interact-creation",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: douyin-interact-creation.",
        ...
        provides_skills=["douyin-interact-creation"],
        activation_events=[],
        permissions=[],
    )
