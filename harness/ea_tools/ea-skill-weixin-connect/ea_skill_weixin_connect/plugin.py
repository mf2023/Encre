"""EA weixin-connect skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-weixin-connect",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: weixin-connect.",
        ...
        provides_skills=["weixin-connect"],
        activation_events=[],
        permissions=[],
    )
