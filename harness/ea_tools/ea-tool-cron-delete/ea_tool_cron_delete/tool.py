...
from encre.tools.runtime import get_scheduler, set_scheduler  # noqa: F401
...
async def _cron_delete_execute(**kwargs: Any) -> str:
    ...
    cancelled = get_scheduler().cancel(job_id)
    if cancelled:
...
cron_delete_tool = build_tool(
    ...
    description=(
        ...
        "Pitfalls: deletion cannot be undone 鈥?a deleted recurring job must be "
...
cron_delete_tool.set_scheduler = set_scheduler
