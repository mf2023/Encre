"""EA gsap-frameworks skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-gsap-frameworks",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: gsap-frameworks.",
        ...
        provides_skills=["gsap-frameworks"],
        activation_events=[],
        permissions=[],
    )
