"""EA mgrep-code-search skill plugin."""
...
class _SkillPlugin(EncrePlugin):
    manifest = PluginManifest(
        name="ea-skill-mgrep-code-search",
        version="0.4.3",
        description="EA (Encre Agent) system-default skill: mgrep-code-search.",
        ...
        provides_skills=["mgrep-code-search"],
        activation_events=[],
        permissions=[],
    )
