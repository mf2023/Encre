  ...
  var Automation = class {
    ...
    openDialog(template, editJob) {
      ...
      overlay.querySelector("#auto-dlg-ok")?.addEventListener("click", () => {
        ...
        if (!name) return;
        const prompt = document.getElementById("auto-dlg-prompt")?.value?.trim() || template.defaultPrompt;
        ...
        const pushToggleEl = document.getElementById("auto-dlg-push-toggle");
    ...
    `
      ...
      this.historyTimelineEl.querySelectorAll(".history-timeline-item").forEach((item) => {
        item.addEventListener("contextmenu", (e) => {
          ...
          if (sid && !isFailed) {
            (0, import_session.showSessionContextMenu)(sid, e.clientX, e.clientY, true, false, void 0, doRename);
          } else if (sid && isFailed) {
            (0, import_session.showSessionContextMenu)(sid, e.clientX, e.clientY, true, true, doDelete, doRename);
          } else if (entryId) {
