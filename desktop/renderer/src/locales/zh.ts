...
export const zh: LocaleMessages = {
  ...
  session: {
    ...
    confirmArchive: "确定要归档会话 \"{name}\"？可在工作区管理的归档管理中恢复。",
    ...
    documentAdded: "资料已添加",
    documentRemoved: "资料已删除",
    documentError: "资料操作失败",
  },
  notifications: {
    empty: "暂无通知",
    title: "通知",
  ...
  settings: {
    ...
    modelPoolFallbackTitle: "模型池自动切换",
    modelPoolFallbackDesc: "当当前模型不可用时，自动切换到池内下一个可用模型",
    modelPoolFallbackCacheHint: "注意：服务端提示缓存按模型隔离。切换模型后，新模型的首次请求将无法命中旧缓存（需全量重算并重新写缓存，计费按全价）。若关注缓存成本，可关闭自动切换。",
    modelPoolSettings: "模型池设置",
    modelPoolEnableTitle: "启用模型池",
    modelPoolEnableDesc: "全局开关：关闭后所有工作区和网关的模型池配置将失效（工作区/网关的独立开关同时隐藏）",
    modelPoolGlobalDisabled: "模型池已在全局设置中禁用，此配置已锁定",
    addModel: "添加模型",
    ...
    storage: "存储",
    storageMigration: "数据迁移",
    storageDangerZone: "危险操作",
    storageDataDir: "数据目录",
    storageSessions: "会话记录",
    storageSessionsDesc: "清除本地数据库中的所有会话历史",
    storageClearSessions: "清除全部",
    storageExportData: "导出全部数据",
    storageExportDataDesc: "导出数据目录下的所有数据（解密后打包为 Zip，不含日志与密钥）",
    storageImportData: "导入全部数据",
    storageImportDataDesc: "从备份 Zip 恢复数据，并按当前机器重新加密写入",
    storageExportTitle: "导出全部数据",
    storageExportConfirm: "将导出数据目录下的所有数据并打包为 Zip。是否继续？",
    storageImportTitle: "导入全部数据",
    storageImportConfirm: "导入将覆盖当前机器的数据文件，并按当前机器重新加密。是否继续？",
    storageImportModeDesc: "该机器可能已存在数据。请选择如何处理备份与现有数据的冲突：",
    storageImportModeOverwrite: "覆盖合并（推荐）",
    storageImportModeOverwriteDesc: "备份中的每个文件都会写入；同路径的现有文件被覆盖，本机独有的文件保留。",
    storageImportModeReplace: "清空并替换",
    storageImportModeReplaceDesc: "先清空当前数据目录，再完整恢复备份，得到源机器的精确克隆。此操作会删除本机现有数据。",
    storageImportModeSkip: "跳过已有文件",
    storageImportModeSkipDesc: "仅写入本机尚不存在的文件；已有文件一律保留，绝不覆盖。",
    storageImportReplaceTitle: "确认清空并替换",
    storageImportReplaceConfirm: "此操作将删除当前机器的全部现有数据，再恢复备份内容，且不可撤销。是否继续？",
    storageImportResult: "导入完成：恢复 {restored} 个文件，覆盖 {overwritten} 个，保留 {kept} 个，跳过 {skipped} 个。",
    storageCurrentFile: "正在处理：",
    storageImportDone: "数据导入完成",
    storageImportFailed: "读取备份文件失败",
    storageImportInvalidZip: "所选文件不是有效的 Encre 备份（缺少格式标记），已拒绝导入。",
    storageExportDone: "导出完成，请选择保存位置",
    storageExportFailed: "导出失败",
    storageFailed: "操作失败",
    about: "关于",
    version: "版本",
    aboutAppName: "应用名称",
    ...
    indexOnlyInWorkspace: "索引与资料库仅在工作区模式下可用。请先打开一个工作区。",
    modeHintAll: "适用于所有模式",
    modeHintIwork: "仅适用于工作模式",
    documentManage: "资料库",
    docManagementDesc: "管理资料库。从本地文件或 URL 添加，为 AI 提供上下文参考。",
    documentCount: "资料数",
    addDocument: "添加资料",
    addDocFromFile: "从文件添加",
    addDocFromUrl: "从 URL 添加",
    docName: "资料名称",
    docNamePlaceholder: "输入资料名称",
    docUrl: "资料 URL",
    ...
    docSize: "大小",
    deleteDoc: "删除资料",
    confirmDeleteDoc: '确定要删除资料 "{name}" 吗？',
    noDocuments: "暂无资料。点击上方按钮添加。",
    documentError: "资料操作失败",
    addSubAgent: "添加智能体",
    editSubAgent: "编辑智能体",
    subAgent: "智能体",
    ...
    adapterTargetModelHint: "配置此网关允许使用的模型池，留空则无限制",
  ...
  workspace: {
    ...
    archiveEmpty: "暂无归档",
    unarchive: "移出归档",
    confirmUnarchiveTitle: "移出归档",
    confirmUnarchive: "确定要将会话 \"{name}\" 移出归档？移出后会重新显示在工作区历史记录中。",
    settingsTitle: "工作区设置",
    workspaceName: "工作区名称",
    ...
    modelSelectionHint: "配置此工作区的模型池，留空则使用全局模型",
