...
On first use, read the guide and confirm platform, PSP, and release target before making code changes.
...
Memory lives in `~/alipay/`. See the guide for setup and status fields.
...
| Topic | File |
|-------|------|
| Setup flow | the guide |
| Memory template | the guide |
| Implementation plan | the guide |
| Validation matrix | the guide |
| Failure recovery | the guide |
| Release and operations | the guide |
| Recurring and subscription flows | the guide |

## Requirements

- Environment variable: `ENCRE_ALIPAY_APP_ID`
- CLI tools for diagnostics: `rest_client`, `jq`
