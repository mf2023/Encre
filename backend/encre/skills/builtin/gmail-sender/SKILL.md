...
Clone or copy this skill to your Encre skills directory:
```bash
cp -r gmail-sender ~/.Encre/workspace/skills/
```
...
0 9 * * 1-5 ~/.Encre/scripts/gmail-send "you@example.com" "Morning Report" "$(date)"
```
