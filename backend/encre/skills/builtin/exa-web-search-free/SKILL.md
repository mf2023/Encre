...
description: Free AI search via Exa MCP. Web search for news/info, code search for docs/examples from GitHub/StackOverflow, company research for business intel. No
metadata:
  source: clawhub
  tags: exa-web-search-free
user_invocable: true
hidden: true
context: inline
---
...
- See [examples.md](external documentation) for more patterns
