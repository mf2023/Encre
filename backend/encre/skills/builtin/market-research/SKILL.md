...
description: Research markets with sizing, segmentation, competitor mapping, pricing checks, and demand validation that turn fuzzy ideas into decision-ready eviden
metadata:
  source: clawhub
...
| Topic | File |
|-------|------|
| Competitor landscape and gap frameworks | the guide |
| Customer validation and pricing methods | the guide |
| Evidence quality and confidence rubric | the guide |
...
See the guide for the confidence ladder. If all evidence comes from one source type, the conclusion is still fragile.
...
Use the guide to build a positioning map, review-mining matrix, and whitespace view. The real competitor is whatever the customer would choose instead of the proposed offer.
...
See the guide for interview, survey, and pricing research structures.
