...
# Public alias reused by sibling modules (e.g. ``encre.commands.registry``)
# so the same frontmatter contract is honoured across skills and commands.
parse_yaml_frontmatter = _parse_yaml_frontmatter
