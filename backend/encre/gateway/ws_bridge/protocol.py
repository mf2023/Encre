...
container used on the wire between :class:`encre.gateway.ws_bridge.server.WsBridgeServer`
and :class:`encre.gateway.ws_bridge.client.GatewayClient`.  Messages are JSON objects of
