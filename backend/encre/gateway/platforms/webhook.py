...
from encre.gateway.platforms.webhook_filters import (
...
class WebhookAdapter(BasePlatformAdapter):
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        # when encre.gateway.multiplex_profiles is on (the handler validates).
        app.router.add_post(
    ...
    def _reload_dynamic_routes(self) -> None:
        ...
        subs_path = data_dir / _DYNAMIC_ROUTES_FILENAME
        ...
        if skills:
            ...
            for skill_name in skills:
                ...
                if cmd_key in skill_cmds:
                    pass  # Skills require agent.skill_commands module
                else:
                    logger.warning(
