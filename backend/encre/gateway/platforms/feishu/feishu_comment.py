...
def _resolve_model_and_runtime() -> Tuple[str, dict]:
    ...
    from encre.gateway.run import _load_gateway_config, _resolve_gateway_model

    user_config = _load_gateway_config()
    model = _resolve_gateway_model(user_config)

    from encre.gateway.run import _resolve_runtime_agent_kwargs
...
def _run_comment_agent(prompt: str, client: Any, session_key: str = "") -> str:
    ...
    logger.info("[Feishu-Comment] _run_comment_agent: lark client stubs (tools not available)")
    def set_doc_client(*a, **kw): pass
    def set_drive_client(*a, **kw): pass
