...
messages to/from the Encre agent.  Zero external dependencies — uses
...
def interactive_setup() -> None:
    ...
    print_info("Connect Encre to an IRC network. Uses Python stdlib — no extra packages needed.")
    ...
    channel = prompt(
        "Channel to join (e.g. #encre — comma-separate for multiple)",
