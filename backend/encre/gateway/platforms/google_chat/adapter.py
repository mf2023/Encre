...
#     fresh "Encre is thinking…" card during the small window between
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # attribute to ``encre.gateway.config.Platform`` — bundled platform plugins
        ...
        # they don't sit in the chat forever as "Encre is thinking…".
...
"action": "encre_clarify",
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'Encre is thinking…' marker message.
        ...
        "Encre is thinking…" stuck in chat forever, plus one card that
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "Encre is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "Encre is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "Encre is thinking…" card during any subsequent
