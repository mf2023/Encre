...
PROVIDERS: list[dict[str, Any]] = [
    ...
    # ── Aggregators ──────────────────────────────────────────────────────
    {
        ...
        "models": [
            ...
            {"id": "openai/gpt-5.6", "label": "GPT-5.6 Sol", "context": 1050000, "modalities": ["text", "image"]},
    ...
    },
    {
        ...
        "auth": "api_key",
        "models": [
            {"id": "kimi-k2.7-code", "label": "Kimi K2.7 Code", "context": 262144, "modalities": ["text"]},
    ...
    },
    {
        ...
        "models": [
            ...
            {"id": "qwen3.8-max-preview", "label": "Qwen3.8-Max-Preview", "context": 1000000, "modalities": ["text", "image"]},
    ...
    # ── Volcengine Ark (火山方舟) ────────────────────────────────────────
    # Each user deploys models to their own inference endpoints, so endpoint
    # IDs (ep-xxxxxx) are unique per account.  Only *model IDs* (the
    # platform-level identifiers like "doubao-pro-32k") are universal.
    # Users must create an inference endpoint in the Ark console and use the
    # assigned endpoint ID as the "model" field.
    {
        "id": "volcengine-ark",
