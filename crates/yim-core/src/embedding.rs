...
//!
//! Text embeddings and similarity utilities.
//!
//! Provides cosine similarity, Jaccard token similarity (always available),
//! and an optional ONNX-backed `TextEmbedder` behind the `embedding` feature.
