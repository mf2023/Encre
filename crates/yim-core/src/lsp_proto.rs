...
//!
//! Fast LSP JSON-RPC message parsing and construction.
//!
//! Provides zero-copy-friendly structs for LSP positions, ranges, and
//! diagnostics, plus helpers for parsing and building the JSON-RPC 2.0
//! messages used by the Language Server Protocol.
