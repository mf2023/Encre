...
class TestEvolutionLearner:
    def setup_method(self):
        self.learner = YmiEvolutionLearner()
    ...
    def test_save_load(self):
        ...
        self.learner.save()
        learner2 = YmiEvolutionLearner(storage_path=path)
    ...
    def test_load_nonexistent(self):
        learner = YmiEvolutionLearner(storage_path="/nonexistent/path/file.json")
...
class TestStrategyOptimizer:
    def setup_method(self):
        self.optimizer = YmiStrategyOptimizer()
...
class TestReflexLoop:
    def setup_method(self):
        self.reflex = YmiReflexLoop(enabled=True)
