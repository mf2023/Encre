...
"""Tests for yim.lsp — LSP protocol dataclasses and YmiLSPClient."""
...
class TestRange:
    ...
    def test_is_dataclass(self):
        from yim.lsp.protocol import Range
        from dataclasses import is_dataclass
...
class TestLocation:
    ...
    def test_is_dataclass(self):
        from yim.lsp.protocol import Location
        from dataclasses import is_dataclass
...
class TestDiagnostic:
    ...
    def test_is_dataclass(self):
        from yim.lsp.protocol import Diagnostic
        from dataclasses import is_dataclass
...
class TestYmiLSPClient:
    """Tests for the YmiLSPClient class."""

    def test_construction(self):
        from yim.lsp.client import YmiLSPClient
        client = YmiLSPClient(server_name="pylsp")
    ...
    def test_construction_different_server_names(self):
        ...
        for name in ["pylsp", "pyright", "rust-analyzer", "gopls", "typescript-language-server"]:
            client = YmiLSPClient(server_name=name)
            assert client._server_name == name

    def test_initial_state(self):
        from yim.lsp.client import YmiLSPClient
        client = YmiLSPClient(server_name="test")
    ...
    def test_public_api_exports(self):
        from yim.lsp import YmiLSPClient, YmiLSPManager, Position, Range, Location, Diagnostic, HoverResult, LSPState
        # Verify all public symbols are importable
        assert YmiLSPClient is not None
        assert YmiLSPManager is not None
...
class TestYmiLSPManager:
    """Tests for the YmiLSPManager class."""

    def test_construction(self):
        from yim.lsp.manager import YmiLSPManager
        manager = YmiLSPManager()
