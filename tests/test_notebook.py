...
"""Tests for yim.notebook.session — YmiNotebookSession."""
...
# ===========================================================================
# YmiNotebookSession construction
# ===========================================================================

class TestYmiNotebookSessionConstruction:
    """Tests for creating YmiNotebookSession instances."""
    ...
    def test_construction_other_python_versions(self):
        ...
        for kname in ["python3.9", "python3.10", "python3.11", "python3.13"]:
            sess = YmiNotebookSession(kernel_name=kname)
    ...
    def test_each_session_has_unique_id(self):
        from yim.notebook.session import YmiNotebookSession
        a = YmiNotebookSession()
        b = YmiNotebookSession()
...
# ===========================================================================
# YmiNotebookSession cell management
# ===========================================================================

class TestYmiNotebookSessionCells:
...
# ===========================================================================
# YmiNotebookSession state
# ===========================================================================

class TestYmiNotebookSessionState:
    """Tests for get_state."""
...
# ===========================================================================
# YmiNotebookSession close
# ===========================================================================

class TestYmiNotebookSessionClose:
