...
:class:`DangerLevel`, and :meth:`YmiSafetyEngine.is_bash_safe`.
"""
...
# ===========================================================================
# YmiSafetyEngine wrapper
# ===========================================================================

class TestYmiSafetyEngineBash:
    """Test the :class:`YmiSafetyEngine` convenience methods."""

    @pytest.fixture
    def engine(self):
        return YmiSafetyEngine(YmiConfig(workspace="/tmp"))
...
class TestPermissionDecisions:
    def test_permission_allow(self):
        from yim.utils.types import PermissionAllow
        a = PermissionAllow()
        assert a.behavior == "allow"

    def test_permission_deny(self):
        from yim.utils.types import PermissionDeny
        d = PermissionDeny()
        assert d.behavior == "deny"

    def test_permission_ask(self):
        from yim.utils.types import PermissionAsk
        q = PermissionAsk()
