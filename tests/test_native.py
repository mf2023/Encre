...
"""Tests for yim.native — Rust native bridge with Python fallbacks."""
...
class TestNativeImport:
    ...
    def test_pyi_stubs_match(self):
        ...
        try:
            from yim import _native as _rust_native  # type: ignore
        except ImportError:
...
class TestReadWriteFile:
    ...
    def test_write_and_read_file(self, tmp_path: Path):
        ...
        content = "Hello, yim native tests!\nLine two.\n"
        ...
        assert "Hello, yim native tests!" in result
