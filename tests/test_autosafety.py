...
"""Tests for yim.autosafety — ML-based safety classifier for auto permission mode."""

import pytest

from yim.autosafety import (
    AutoDecision,
...
class TestYmiAutoSafetyClassifier:
    def setup_method(self):
        self.classifier = YmiAutoSafetyClassifier()
    ...
    def test_learn_from_user_respects_cache_size(self):
        c = YmiAutoSafetyClassifier(cache_size=10)
        for i in range(20):
