...
from yim.memdir.semantic import _tokenize, _jaccard_similarity, _build_idf, _tf_idf_vectorize, _cosine_similarity
...
class TestMemoryScanBench:
    ...
    def test_semantic_search_performance(self):
        ...
        from yim.memdir.semantic import SemanticMemorySearch
...
class TestConsolidationBench:
    def test_consolidate_many_files(self):
        tmpdir = tempfile.mkdtemp()
        from yim.memdir.semantic import MemoryConsolidator
