...
class TestFactoryFunctionEdgeCases:
    ...
    def test_create_finish_with_usage(self):
        from yim.utils.types import create_finish
    ...
    def test_create_text_delta_empty(self):
        from yim.utils.types import create_text_delta
        e = create_text_delta("")
        assert e.text == ""
    ...
    def test_create_tool_result_with_error(self):
        from yim.utils.types import create_tool_result
    ...
    def test_create_permission_request(self):
        from yim.utils.types import create_permission_request
    ...
    def test_create_backend_thinking_with_signature(self):
        from yim.utils.types import create_backend_thinking
    ...
    def test_create_backend_error_long_message(self):
        from yim.utils.types import create_backend_error
