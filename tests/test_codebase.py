...
"""Tests for yim.codebase.indexer — YmiCodeIndex and ModuleInfo."""
...
# ===========================================================================
# YmiCodeIndex construction
# ===========================================================================

class TestYmiCodeIndexConstruction:
    """Tests for YmiCodeIndex construction and initial state."""
    ...
    def test_construction_absolute_path(self):
        ...
        ci = YmiCodeIndex(workspace=abs_path)
    ...
    def test_known_extensions_set(self):
        from yim.codebase.indexer import YmiCodeIndex
        assert ".py" in YmiCodeIndex._KNOWN_EXTS
        assert ".rs" in YmiCodeIndex._KNOWN_EXTS
        assert ".go" in YmiCodeIndex._KNOWN_EXTS
        assert ".js" in YmiCodeIndex._KNOWN_EXTS
        assert ".ts" in YmiCodeIndex._KNOWN_EXTS
        assert ".java" in YmiCodeIndex._KNOWN_EXTS


# ===========================================================================
# YmiCodeIndex scan and search
# ===========================================================================

class TestYmiCodeIndexScan:
    ...
    def test_scan_empty_directory(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ci = YmiCodeIndex(workspace=tmpdir)
            ci.scan()
            assert ci._indexed is True
            assert len(ci._modules) == 0
    ...
    def test_scan_nonexistent_directory(self):
        from yim.codebase.indexer import YmiCodeIndex
        ci = YmiCodeIndex(workspace="/nonexistent/path/for/testing")
        ci.scan()
        assert ci._indexed is True
        assert len(ci._modules) == 0


class TestYmiCodeIndexWithFiles:
...
# ===========================================================================
# YmiCodeIndex public query API
# ===========================================================================

class TestYmiCodeIndexQueries:
...
# ===========================================================================
# YmiCodeIndex incremental scan
# ===========================================================================

class TestYmiCodeIndexIncremental:
