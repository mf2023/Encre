...
"""Tests for yim.computer.browser — YmiBrowserSession and BrowserState."""
...
# ===========================================================================
# YmiBrowserSession construction
# ===========================================================================

class TestYmiBrowserSessionConstruction:
    """Tests for YmiBrowserSession construction."""

    def test_default_construction(self):
        from yim.computer.browser import YmiBrowserSession
        session = YmiBrowserSession()
...
# ===========================================================================
# YmiBrowserSession state methods (no browser needed)
# ===========================================================================

class TestYmiBrowserSessionState:
...
# ===========================================================================
# YmiBrowserSession check_playwright
# ===========================================================================

class TestYmiBrowserSessionCheckPlaywright:
...
# ===========================================================================
# YmiBrowserSession public API exports
# ===========================================================================
...
class TestBrowserPublicAPI:
    ...
    def test_public_exports(self):
        from yim.computer import YmiBrowserSession, BrowserState
        assert YmiBrowserSession is not None
