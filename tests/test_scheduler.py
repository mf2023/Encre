...
:class:`YmiScheduler`, :class:`ScheduleType`, and :class:`JobState`.
"""
...
# ===========================================================================
# YmiScheduler: scheduling and cancellation
# ===========================================================================

class TestYmiSchedulerBasic:
    """Test :class:`YmiScheduler` schedule and cancel methods."""
...
# ===========================================================================
# YmiScheduler: durable persistence
# ===========================================================================

class TestYmiSchedulerDurability:
    ...
    def test_durable_save_and_load(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            sched1 = YmiScheduler(durable_path=path)
            ...
            sched2 = YmiScheduler(durable_path=path)
    ...
    def test_durable_creates_parent_dir(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            sched = YmiScheduler(durable_path=path)
