...
"""Tests for resolve_thinking_config and get_thinking_budget_tokens from yim.thinking."""

import inspect
import pytest

from yim.thinking.config import resolve_thinking_config, get_thinking_budget_tokens
