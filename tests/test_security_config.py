...
class TestRateLimiter:
    def test_create(self):
        rl = YmiRateLimiter(per_minute=60)
    ...
    def test_first_request_allowed(self):
        rl = YmiRateLimiter(per_minute=999)
...
class TestConfig:
    ...
    def test_backend_kwargs(self):
        cfg = YmiConfig(backend_kwargs={"temperature": 0.7})
    ...
    def test_tool_result_max_chars(self):
        cfg = YmiConfig(tool_result_max_chars=50000)
        assert cfg.tool_result_max_chars == 50000


class TestTelemetry:
    def setup_method(self):
        self.tel = YmiTelemetry()
    ...
    def test_disabled_telemetry(self):
        tel = YmiTelemetry(enabled=False)
...
class TestSandboxTypes:
    def test_sandbox_config(self):
        from yim.sandbox.types import SandboxConfig
    ...
    def test_sandbox_result(self):
        from yim.sandbox.types import SandboxResult
